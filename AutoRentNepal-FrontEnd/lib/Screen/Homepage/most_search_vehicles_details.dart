...
//   static const routeName = '/vehicle-detail-screens';
...
class MostSearchVehicless extends StatelessWidget {
  static const routeName = 'most-search-vehicle';
  const MostSearchVehicless({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final vehicle =
        Provider.of<VehicleState>(context).singleMostSearchV(id as int);
